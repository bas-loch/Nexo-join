    ...
    <div className="min-h-screen bg-sand font-sans text-navy selection:bg-gold/30">
        ...
        <div className="grid gap-12 lg:grid-cols-3">
          <a href="#aquapark" className="group">
            <div className="aspect-[4/5] w-full overflow-hidden mb-6">
              <img src={aquaparkHero} alt="Toboggans de l'Aqua Park Zodiac" loading="lazy" width={800} height={1000} className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105" />
            </div>
          ...
          <a href="#bienetre" className="group">
            <div className="aspect-[4/5] w-full overflow-hidden mb-6">
              <img src={spa1} alt="Espace spa et bien-être" loading="lazy" width={800} height={1000} className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105" />
            </div>
          ...
          <a href="#hotel" className="group">
            <div className="aspect-[4/5] w-full overflow-hidden mb-6">
              <img src={beach1} alt="Plage privée de sable fin" loading="lazy" width={800} height={1000} className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105" />
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            {[
              ...
              { img: roomTriple, name: "Chambre Double à Usage Triple", meta: "Jusqu'à 3 personnes" },
      ...
      <section id="aquapark" className="py-24 px-6 lg:px-12 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="aspect-[4/5] overflow-hidden order-2 lg:order-1">
            <img src={aquapark2} alt="Toboggans géants Aqua Park" loading="lazy" width={800} height={1000} className="h-full w-full object-cover" />
          </div>
          <div className="order-1 lg:order-2">
            <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">Exclusivité Zodiac</span>
            <h2 className="mt-4 font-serif text-4xl md:text-5xl leading-tight">Un aquapark pour toute la famille</h2>
            <p className="mt-6 text-stone-600 leading-relaxed max-w-lg">
              L'un des plus grands parcs aquatiques de Yasmine Hammamet. Entre toboggans multipistes et piscines relaxantes, l'accès est illimité pour tous nos résidents.
            </p>
            <ul className="mt-8 space-y-4 text-sm">
              {["Piscines extérieures", "Toboggans multipistes", "Espace sécurisé pour les jeunes enfants", "Animations et clubs enfants"].map((f) => (
        ...
        <div className="mt-8 grid grid-cols-2 gap-4 md:grid-cols-4">
          {[aquapark1, slideCloseUp, kidsClub, eveningShow].map((img, i) => (
            <div key={i} className="aspect-[4/5] overflow-hidden">
              <img src={img} alt="" loading="lazy" className="h-full w-full object-cover hover:scale-105 transition-transform duration-700" />
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="bienetre" className="bg-white py-24 px-6 lg:px-12">
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8">
          <div className="relative overflow-hidden group">
            <img src={spa2} alt="Spa et hammam" loading="lazy" width={800} height={1000} className="h-full w-full object-cover aspect-[4/5] group-hover:scale-105 transition-transform duration-700" />
      ...
      <section id="spa" className="py-24 px-6 lg:px-12 max-w-7xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">Zodiac Spa & Piscines</span>
          ...
          <p className="mt-6 text-stone-600 leading-relaxed">
            Deux piscines extérieures d'eau douce, puis le Zodiac Spa : hammam, salon de repos aux zelliges tunisiens et cabines de massage pour un moment hors du temps.
          </p>
        </div>

        <div className="grid grid-cols-12 gap-4 md:gap-6">
          <div className="col-span-12 md:col-span-8 aspect-[16/10] overflow-hidden">
            <img src={outdoorPool} alt="Piscines extérieures de l'Hôtel Zodiac" loading="lazy" className="h-full w-full object-cover hover:scale-105 transition-transform duration-700" />
          </div>
          <div className="col-span-12 md:col-span-4 aspect-[4/5] md:aspect-auto overflow-hidden">
            <img src={loungeSalon} alt="Salon de repos du spa" loading="lazy" className="h-full w-full object-cover hover:scale-105 transition-transform duration-700" />
          </div>
      ...
      <section id="reception" className="py-24 px-6 lg:px-12 max-w-7xl mx-auto">
        <div className="text-center max-w-2xl mx-auto mb-16">
          ...
          <p className="mt-6 text-stone-600 leading-relaxed">
            Sous la coupole ornée, notre réception et notre bar-lobby vous accueillent dans un décor mêlant artisanat tunisien, arcs en pierre et lustres dorés.
          </p>
        </div>

        <div className="grid grid-cols-12 gap-4 md:gap-6">
          <div className="col-span-12 md:col-span-8 aspect-[16/10] overflow-hidden">
            <img src={receptionHall} alt="Réception sous la coupole du zodiaque" loading="lazy" className="h-full w-full object-cover hover:scale-105 transition-transform duration-700" />
          </div>
          <div className="col-span-12 md:col-span-4 aspect-[4/5] md:aspect-auto overflow-hidden">
            <img src={domeAerial} alt="Vue aérienne des coupoles et de la piscine" loading="lazy" className="h-full w-full object-cover hover:scale-105 transition-transform duration-700" />
          </div>
          <div className="col-span-12 md:col-span-6 aspect-[16/10] overflow-hidden">
            <img src={barLobby} alt="Bar-lobby aux arcs tunisiens" loading="lazy" className="h-full w-full object-cover hover:scale-105 transition-transform duration-700" />
          </div>
          <div className="col-span-12 md:col-span-6 aspect-[16/10] overflow-hidden">
            <img src={gardenView} alt="Chambre avec vue sur les jardins" loading="lazy" className="h-full w-full object-cover hover:scale-105 transition-transform duration-700" />
          </div>
        </div>
      </section>
      ...
      <section className="py-24 px-6 lg:px-12 max-w-6xl mx-auto text-center">
        ...
        <h2 className="mt-4 font-serif text-4xl md:text-5xl">Ce que retiennent nos clients</h2>
        <div className="mt-16 grid gap-8 md:grid-cols-3 text-left">
          {[
            { q: "L'équipe d'animation est exceptionnelle, toujours de bonne humeur avec les enfants comme avec les adultes.", a: "Famille en séjour", src: "Yasmine Hammamet" },
            { q: "Aqua park très apprécié par nos enfants, ils n'en sont pas sortis de la journée.", a: "Client", src: "Séjour d'une semaine" },
            { q: "Personnel attentionné et disponible, un hôtel où l'on se sent bien du premier au dernier jour.", a: "Client fidèle", src: "de l'hôtel" },
          ].map((r) => (
      ...
      <section className="bg-navy py-24 px-6 text-center text-white lg:px-12">
        <div className="mx-auto max-w-2xl">
          <span className="text-[10px] font-bold uppercase tracking-[0.3em] text-gold">Réservation directe</span>
        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-12">
          <div>
            ...
            <p className="mt-4 text-sm text-stone-600 leading-relaxed">
              BP 243, Zone touristique<br />8050 Yasmine Hammamet<br />Tunisie
            </p>
          </div>
          <div>
            <h3 className="font-serif text-xl">Réservations</h3>
            <p className="mt-3 text-sm text-stone-600">Tél : +216 72 244 085</p>
            <p className="text-sm text-stone-600">Email : resa@hotelzodiac.com</p>
